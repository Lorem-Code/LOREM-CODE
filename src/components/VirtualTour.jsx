  ...
  return (
    <div className='bg-gray-100 justify-center items-center min-h-screen'>
        <header className='text-center py-9'>
            <h1 className='text-3xl md:text-5xl font-bold mb-4'>Virtual Tour Candi Borobudur</h1>
        ...
        <iframe src="https://indonesiavirtualtour.com/storage/destination/candi-borobudur/src/index.htm" frameborder="0" className='max-w-7xl w-full h-[90vh] rounded-lg'></iframe>
        </div>
